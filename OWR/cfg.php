...
// ini_set('include_path', HOME_PATH.'libs'.DIRECTORY_SEPARATOR.PATH_SEPARATOR.ini_get('include_path'));
...
$cfg['dbpasswd']                = 'openwebreader313!';
// generally /var/run/mysqld.sock
$cfg['dbsocket']                = '/tmp/mysql.sock';
