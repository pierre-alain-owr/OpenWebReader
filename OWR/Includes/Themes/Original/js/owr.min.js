...
var OWR={};OWR=function(e,t,s,i){this.init(e,t,s,i)},OWR.prototype={currentId:0,pageOffset:0,menuTogglerStatus:0,isLoading:0,adding:"",period:0,TS:[],nbLogsLine:0,sortables:!1,aAcc:{},lang:"",languages:["fr_FR","en_US"],messages:[],lastUpd:0,ttl:0,keywords:"",sort:"",dir:"",token:"",boardTogglerStatus:1,live:1,ssrequest:null,init:function(e,t,s){this.loading(!0),this.languages.contains(e)||(e="en_US"),this.lang=e,this.ttl=t/1e3,this.lastUpd=this.getTS(),this.period=this.getLastNews.periodical(t,this);var i,n,o=window.location.search.replace(/^\?/,"").split("&");for(n=0;n<o.length;n++)if(i=o[n].split("="),"token"===i[0]){this.token=i[1];break}switch($$("a[href^="+window.location.origin+"],link[rel=search]").each(function(e){var t=e.get("href");-1===t.indexOf("logout")&&e.set("href",t+(-1===t.indexOf("?")?"?token=":"&token=")+this.token)}.bind(this)),this.lang){case"fr_FR":this.messages["Loading interface"]="Chargement de l'interface",this.messages["Adding a category"]="Ajout d'une catégorie",this.messages["Adding a stream"]="Ajout d'un flux",this.messages["Searching for keywords"]="Recherche des mots-clés",this.messages["Renaming the element"]="Renomage de l'élément",this.messages["Moving the element"]="Déplacement de l'élement",this.messages["Asking for the RSS gateway token"]="Demande du lien pour la passerelle RSS",this.messages["Asking for the OPML gateway token"]="Demande du lien pour la passerelle OPML",this.messages["Asking for the REST auth token"]="Demande des identifiants de connexion REST",this.messages["Refreshing the interface"]="Mise à jour de l'interface",this.messages["Marking news as read"]="Marquage des nouvelles comme lues",this.messages["Refreshing the menu"]="Mise à jour du menu",this.messages["Getting the news"]="Récupération des nouvelles",this.messages["Asking for refreshing of streams"]="Demande de mise à jour des flux",this.messages.Deleting="Suppression",this.messages["Moving to page "]="Déplacement vers la page ",this.messages["Deleting news"]="Suppression des nouvelles",this.messages["Making the maintenance.. please wait, it may take a while"]="Maintenance en cours, celà peut prendre un certain temps",this.messages["Setting the new interface language"]="Mise à jour de la langue de l'interface",this.messages["Getting the list of the users"]="Récupération des données utilisateurs",this.messages["Wait wait ! A request is still running ! Please confirm you are leaving"]="Attendez ! Attendez ! Une requête est toujours en cours ! Veuillez confirmer que vous partez",this.messages["Abort current request to the server ?"]="Abandonner la requête en cours vers le serveur ?",this.messages["Delete ?"]="Supprimer ?",this.messages["Getting contents of the category"]="Récupération du contenu de la catégorie",this.messages["Getting details of the stream"]="Récupération des détails du flux",this.messages["Getting contents of the new"]="Récupération du contenu de la nouvelle",this.messages["Clearing myself, bye !"]="Nettoyage en cours, à bientôt !",this.messages["Getting details of the new"]="Récupération des informations de la nouvelle",this.messages["Marking news as unread"]="Marquage des nouvelles comme non-lues",this.messages["Editing the url of the stream"]="Édition de l'url du flux",this.messages["Editing tags"]="Édition des tags",this.messages["Getting tags"]="Récupération des tags",this.messages["Generating some statistics"]="Génération des statistiques",this.messages["Asking logs"]="Affichage des logs CLI",this.messages["Getting category"]="Récupération de la catégorie";break;case"en_US":}var a=this.setLog("Loading interface");this.setTS(),this.initMenu(!0),this.initContents(),"0"!==s&&(this.currentId="search",this.initCurrent(),$("menu_title_streams").getNext().toggle(),$("keywords").set("value",s),$("menu_tools").getNext().toggle(),$("do_search").status=1,$("contents_do_search").slide("in")),this.loading(!1,a)},getMessage:function(e){return $defined(this.messages[e])?this.messages[e]:e},initMenu:function(e){this.loading(!0),e?($$("div.menu_actions_toggler").removeEvents("click").each(function(e){e.addEvent("click",function(e,t){e.stop();var s=t.get("id");t.status?(t.status=!t.status,$("contents_"+s).slide()):(t.status=1,$("contents_"+s).setStyles({display:"block",visibility:"visible"}).slide("in"))}.bindWithEvent(this,e))},this),$$("div.menu_actions_contents").each(function(e){e.slide("out")}),$$("li.menu_part_title").each(function(e,t){var s=e.getNext();t>0&&s.toggle(),e.removeEvents("click").addEvent("click",function(){this.toggle()}.bindWithEvent(s))})):this.initSortables(),this.loading(!1)},gstreamsToggle:function(e,t){var s=$("groupContainer_"+e);$defined(t.status)?(t.setStyle("background-position",t.status?"-303px 0px":"-319px 0px"),s.getParent().setStyle("height","auto"),s.toggle(),t.status=!t.status):this.getMenuPartGroup(e)},toggleBoard:function(){var e=$("board");0===this.boardTogglerStatus?($("main").setStyle("margin-top","65px"),$("news_ordering")&&$("news_ordering").setStyle("top","65px"),e.setStyle("display","block"),$("board_toggler").setStyle("background-position","-692px 0px").setStyle("top","65px"),$("menu_toggler").setStyle("top","65px"),this.boardTogglerStatus=1):($("news_ordering")&&$("news_ordering").setStyle("top","10px"),$("main").setStyle("margin-top","10px"),e.setStyle("display","none"),$("board_toggler").setStyle("background-position","-675px 0px").setStyle("top","10px"),$("menu_toggler").setStyle("top","10px"),this.boardTogglerStatus=0)},manageToggler:function(e){e||0===this.menuTogglerStatus?($("menu").setStyle("display","none"),$("contents").getParent().setStyle("margin-left","0").removeClass("span8").addClass("span12"),$("menu_toggler").setStyle("background-position","-18px 0px"),this.menuTogglerStatus=1):($("contents").getParent().setStyle("margin-left","").removeClass("span12").addClass("span8"),$("menu").setStyle("display","block"),$("menu_toggler").setStyle("background-position","0px 0px"),this.menuTogglerStatus=0)},loadImage:function(e,t){this.loading(!0);var s=e.getFirst(),i=e.getParent("div.article_contents"),n=i.getParent().getSize(),o=i.getSize();s.addEvent("load",function(){e.set("title",t),e.set("target","_blank"),e.onclick=function(){this.set("href",t)},i.getParent().setStyle("height",n.y+(i.getSize().y-o.y)),this.loading(!1)}.bindWithEvent(this)),s.set("src",t),e.set("class","")},initContents:function(){this.loading(!0),$$("div[class^=article_title]").removeEvents("click").each(function(e){var t;e.addEvent("click",function(e,s){return $clear(t),e.target.hasClass("link_go")?(s.hasClass("new_container_nread")&&this.updateNews(s.get("id").split("_")[1]),!1):e.target.hasClass("new_status")||e.target.hasClass("new_tag")||e.target.hasClass("new_tags")||e.target.hasClass("delete")||e.target.hasClass("read")?!1:(e.stop(),void(t=function(){var e=s.get("id").split("_"),t=$("new__"+e[1]+"_"+e[2]+"_"+e[3]);if(!t)return!1;if(t.get("html").trim()){var i=(s.getStyle("color"),!1);if(s.hasClass("opened")?($("new_abstract_"+e[1])&&$("new_abstract_"+e[1]).removeClass("hidden"),s.removeClass("opened")):($("new_abstract_"+e[1])&&$("new_abstract_"+e[1]).addClass("hidden"),s.addClass("opened"),i=!0),t.toggle(),i){var n=new Fx.Scroll(document.body,{wheelStops:!0,offset:{x:0,y:s.getPosition().y-105}});n.toTop()}}else $("new_abstract_"+e[1])&&$("new_abstract_"+e[1]).addClass("hidden"),this.getNew(s.get("id"))}.delay(200,this)))}.bindWithEvent(this,e)),e.addEvent("dblclick",function(e,s){return e.target.hasClass("new_status")||e.target.hasClass("new_tag")||e.target.hasClass("new_tags")?!1:($clear(t),window.open(s.getElements(".link_go").get("href")),void(s.hasClass("new_container_nread")&&this.updateNews(s.get("id").split("_")[1])))}.bindWithEvent(this,e))},this),this.loading(!1)},setLogs:function(e,t){e&&$each(e,function(e){"object"==typeof e?this.setLogs(e,t):this.setLog(e,t)},this)},parseResponse:function(e,t,s){if(e){if(e.location&&(window.location.href=e.location),e.logs&&this.setLogs(e.logs),e.errors&&this.setLogs(e.errors,!0),$defined(e.contents)){if(s){var s=$(s);return s&&(s.empty(),s.set("html",e.contents),s.getElements("script[data-owr=plugins]").each(function(e){$exec(e.text)})),e.unreads&&this.getUnread(e.unreads),""}return e.unreads&&this.getUnread(e.unreads),e.contents}if(s){var s=$(s);s&&(s.empty(),s.set("html",e),s.getElements("script[data-owr=plugins]").each(function(e){$exec(e.text)}))}e.unreads&&this.getUnread(e.unreads)}else if(t&&this.setLog(t,!0),s){var s=$(s);s&&s.empty()}return""},editStreamGroupsFormAction:function(){var e=$("editstreamgroup"),t=e.getChildren().getChildren("input[name=name]")[0].get("value");if(""===t)return!1;this.loading(!0);var s=this.setLog("Adding a category"),i=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});return i.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,s)),i.addEvent("success",function(e,s){this.loading(!1,s);var i=this.parseResponse(e);if(i.id=i.id.toInt(),$$("select[id^=move_]").each(function(e){var s=!1;if(e.getChildren("option").each(function(e){e.get("value").toInt()===i.id&&(s=!0)}),!s){var n=new Element("option",{value:i.id});n.appendText(t),n.inject(e)}}),!$("stream_"+i.id)&&i.menu){var n=new Element("div");n.set("html",i.menu),$("menu_streams").grab(n.getFirst()),$$("a.anchor")||this.initMenu()}}.bindWithEvent(this,s)),i.post(e),!1},editStreamFormAction:function(){this.loading(!0);var e=this.setLog("Adding a stream"),t=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});return t.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,e)),t.addEvent("success",function(e,t){this.loading(!1,t);var s=this.parseResponse(e);if(s){var i=new Element("div",{html:s}),n=i.getFirst(),o=$("move_category").get("value");if(o.toInt()){var a=$("stream_"+o),r=$("groupContainer_"+o);a?r?n.inject(r):$("gstream_toggler_"+o).click():this.getStreamGroup(o)}else this.getStreamGroup();this.initMenu()}}.bindWithEvent(this,e)),t.post($("editstream")),!1},getStreamGroup:function(e,t){e="undefined"!=typeof e?e:0,t="undefined"!=typeof t?t:!0,this.loading(!0);var s=this.setLog("Getting category"),i=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});return i.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,s)),i.addEvent("success",function(e,s){this.loading(!1,s);var i=this.parseResponse(e);if(i){var n=new Element("div",{html:i}),o=n.getFirst(),a=o.get("id"),r=$(a);r?o.replaces(r):o.inject("menu_streams"),this.initMenu(),t&&$("gstream_toggler_"+a.split("_")[1]).click()}}.bindWithEvent(this,s)),i.get({"do":"getstreamgroup",id:e}),!1},searchFormAction:function(e){var t="";if(e?t=$("search_"+e).get("value"):(t=$("keywords").get("value"),e=0),""===t)return!1;this.loading(!0);var s=this.setLog("Searching for keywords");this.setLog('"'+t+'"');var i=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});return i.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,s)),i.addEvent("success",function(e,t,s,i){this.loading(!1,t),this.parseResponse(e,null,"body_container"),this.initContents(),this.pageOffset=0,this.keywords=s,this.currentId="search_"+i,this.initCurrent();var n=new Fx.Scroll(document.body,{wheelStops:!0,offset:{x:0,y:$("contents").getPosition().y-105}});n.toTop()}.bindWithEvent(this,[s,t,e])),e?i.post({"do":"search",id:e,keywords:t}):i.post($("search_0")),!1},searchStream:function(e){if(e){this.loading(!0);var t=$("search_"+e),s=$("stream_toggler_"+e);s||(s=$("gstream_toggler_"+e)),"block"==t.getStyle("display")?(this.sortables&&(s.status?this.sortables.addItems(s.getParents()[1]):this.sortables.removeItems(s.getParents()[1])),t.setStyle("display","none")):(this.sortables&&this.sortables.removeItems(s.getParents()[1]),t.setStyles({display:"block",visibility:"visible"})),this.loading(!1)}},raiseXHRError:function(e,t){this.loading(!1,t,!0),e=JSON.decode(e,!0),e.errors&&this.setLogs(e.errors,!0),e.unreads&&this.getUnread(e.unreads)},inputRename:function(e){this.loading(!0);var t=e.get("value");if(""===t)return e.setStyle("display","none"),void this.loading(!1);var s=e.get("id").split("_")[1],i=$("showStream_"+s).get("html");myRegexp=new RegExp('(<span class="title">)(.*?)(</span>)',"gi");var n=i.replace(myRegexp,"$1"+t+"$3");if(i==n)return e.setStyle("display","none"),void this.loading(!1);var o=this.setLog("Renaming the element"),a=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});a.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,o)),a.addEvent("success",function(e,t,i){this.loading(!1,t),this.parseResponse(e),$("showStream_"+s).set("html",i),$("stream_"+s).hasClass("groups")&&(i=i.replace(myRegexp,"$1"),$$("select[id^=move_]").each(function(e){var t=!1;if(e.getChildren("option").each(function(e){e.get("value").toInt()==s&&(e.set("html",i),t=!0)}),!t){var n=new Element("option",{value:s});n.inject(e),n.appendText(i)}})),this.sortables&&!$("stream_toggler_"+s).status&&this.sortables.addItems($("stream_"+s))}.bindWithEvent(this,[o,n])),a.post({"do":"rename",name:e.get("value"),id:s}),e.setStyle("display","none")},inputEditStreamUrl:function(e){this.loading(!0);var t=e.get("value");if(""===t)return e.setStyle("display","none"),void this.loading(!1);var s=e.get("id").split("_")[1],i=e.getParents(".menu_groups")[0].get("id").split("_")[1],n=this.setLog("Editing the url of the stream"),o=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});o.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,n)),o.addEvent("success",function(e,t,s){this.loading(!1,t),this.parseResponse(e),this.getMenuPartGroup(s),this.showStream(0)}.bindWithEvent(this,[n,i])),o.post({"do":"editstream",url:e.get("value"),id:s}),e.setStyle("display","none")},selectMove:function(e){this.loading(!0);var t=this.setLog("Moving the element"),s=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});s.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,t)),s.addEvent("success",function(e,t,s){this.loading(!1,t),this.parseResponse(e);var i=$("stream_"+s.get("id").split("_")[1]),n=$("gstream_toggler_"+s.get("value"));i&&n.status?i.inject($("groupContainer_"+s.get("value"))):i.destroy(),this.initMenu(),this.initCurrent()}.bindWithEvent(this,[t,e])),s.post({"do":"move",id:e.get("id").split("_")[1],gid:e.get("value")})},getRestAuthToken:function(){this.loading(!0);var e=this.setLog("Asking for the REST auth token"),t=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});t.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,e)),t.addEvent("success",function(e,t){this.loading(!1,t);var s=this.parseResponse(e);prompt("",s)}.bindWithEvent(this,e)),t.get({"do":"regeneraterestauthtoken"})},getRssToken:function(e){this.loading(!0);var t=this.setLog("Asking for the RSS gateway token"),s=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});s.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,t)),s.addEvent("success",function(e,t){this.loading(!1,t);var s=this.parseResponse(e);prompt("",s)}.bindWithEvent(this,t)),s.get({"do":"regeneratersstoken",id:e})},editOPML:function(){if($("opml").get("value").length){this.loading(!0);var e=this.setLog("Adding a stream"),t=new Element("iframe");t.set({id:"ieditopml",name:"ieditopml"}),t.setStyles({width:0,height:0,border:"none"});var s=$("editopml");s.set("action","./?do=editopml&token="+this.token),s.set("target","ieditopml"),s.getParent().adopt(t),t.addEvent("load",function(e,t){this.loading(!1,t),$("ieditopml").destroy(),window.location="./?token="+this.token}.bindWithEvent(this,e)),s.submit()}else{var i=$("url").get("value");if(!i)return!1;this.loading(!0);var e=this.setLog("Adding a stream"),n=new Request.JSON({url:"./?do=editopml&token="+this.token});n.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,e)),n.addEvent("success",function(e,t){this.loading(!1,t),this.parseResponse(e)}.bindWithEvent(this,e)),n.post($("editopml"))}return!1},getOpmlToken:function(e){this.loading(!0);var t=this.setLog("Asking for the OPML gateway token"),s=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});s.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,t)),s.addEvent("success",function(e,t){this.loading(!1,t);var s=this.parseResponse(e);prompt("",s)}.bindWithEvent(this,t)),s.get({"do":"regenerateopmltoken",id:e})},initCurrent:function(){if(this.loading(!0),"string"==typeof this.currentId&&-1!==this.currentId.indexOf("search_")){var e=this.currentId.split("_")[1].toInt();$$("span[id^=current_]").setStyle("display","none"),e?$("current_"+e+"_all").setStyle("display","inline-block").removeClass("hidden"):$("current_search").setStyle("display","inline-block").removeClass("hidden")}else $$("span[id^=current_]").setStyle("display","none"),$("current_"+this.currentId+(this.live?"":"_all")).setStyle("display","inline-block").removeClass("hidden");this.loading(!1)},initSortables:function(){return this.sortables?void $$("ul.menu_groups").each(function(e){this.sortables.lists.contains(e)||this.sortables.addLists(e)},this):(this.sortables=new Sortables($$("ul.menu_groups"),{clone:!0,revert:!0,opacity:.5,onStart:function(e){this.currentgid=e.getParent().get("id").split("_")[1].toInt()}}),void this.sortables.addEvent("complete",function(e,t){if(t.currentgid){var s=e.getParent().get("id").split("_")[1].toInt();if(s===t.currentgid)return void(t.currentgid=0);var i=e.get("id").split("_")[1];t.currentgid=0,this.moveSortables(i,s)}}.bindWithEvent(this,this.sortables)))},streamsToggle:function(e,t){var s=$("streamContainer_"+e);if($defined(t.status))t.setStyle("background-position",t.status?"-303px 0px":"-319px 0px"),t.getParents()[2].setStyle("height","auto"),s.toggle(),this.sortables&&(t.status?this.sortables.addItems(t.getParents()[1]):this.sortables.removeItems(t.getParents()[1])),t.status=!t.status;else{if(!s){var i=$("stream_"+e);if(!i)return;i.adopt(new Element("ul",{id:"streamContainer_"+e,"class":"stream_more"}))}this.getMenuPartStream(e),this.sortables&&this.sortables.removeItems(t.getParents()[1])}},moveSortables:function(e,t){if(e&&t){this.loading(!0);var s=this.setLog("Moving the element"),i=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});i.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,s)),i.addEvent("success",function(e,t){this.loading(!1,t),this.parseResponse(e)}.bindWithEvent(this,s)),i.post({"do":"move",id:e,gid:t})}},loading:function(e,t,s){if(e)this.isLoading||($("logo").addClass("hide"),$("logo-loading").removeClass("hide")),++this.isLoading;else if(this.isLoading>0&&--this.isLoading,this.isLoading||($("logo-loading").addClass("hide"),$("logo").removeClass("hide")),$chk(t)){t=t.toInt();var i=$("logs").getChildren()[t];i&&i.set("html",'<span style="color:'+(s?"red":"green")+'">'+i.get("html")+"</span>")}},editStreamUrl:function(e){if(e){this.loading(!0);var t=$("editurl_"+e);"inline"==t.getStyle("display")?(t.setStyle("display","none"),this.sortables&&!$("stream_toggler_"+e).status&&this.sortables.addItems(t.getParents("li[id^=stream_]")[0])):(this.sortables&&this.sortables.removeItems(t.getParents("li[id^=stream_]")[0]),t.setStyles({display:"inline",visibility:"visible"})),this.loading(!1)}},renameStream:function(e){if(e){this.loading(!0);var t=$("rename_"+e);"block"==t.getStyle("display")?(t.setStyle("display","none"),this.sortables&&!$("stream_toggler_"+e).status&&this.sortables.addItems(t.getParents("li[id^=stream_]")[0])):(this.sortables&&this.sortables.removeItems(t.getParents("li[id^=stream_]")[0]),t.setStyles({display:"block",visibility:"visible"})),this.loading(!1)}},moveStream:function(e){if(e){this.loading(!0);var t=$("move_"+e);t.setStyles("inline"==t.getStyle("display")?{display:"none"}:{display:"inline",visibility:"visible"}),"inline"==t.getStyle("display")?this.sortables&&!$("stream_toggler_"+e).status&&this.sortables.removeItems(t.getParents("li[id^=stream_]")[0]):this.sortables&&this.sortables.addItems(t.getParents("li[id^=stream_]")[0]),this.loading(!1)}},getUnread:function(e){if(this.loading(!0),e)$$("span[id^=unread_]").each(function(t){var s=t.get("id").split("_");e[s[1]]?(t.set("html",e[s[1]]),t.getParent().setStyle("font-weight","bold")):(t.set("html","0"),t.getParent().setStyle("font-weight","normal"))}),this.lastUpd=this.getTS(),this.loading(!1);else{var t=this.setLog("Refreshing the interface"),s=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});s.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,t)),s.addEvent("success",function(e,t){this.loading(!1,t),$$("span[id^=unread_]").each(function(t){var s=t.get("id").split("_");e.contents[s[1]]?(t.set("html",e.contents[s[1]]),t.getParent().setStyle("font-weight","bold")):(t.set("html","0"),t.getParent().setStyle("font-weight",""))}),this.lastUpd=this.getTS()}.bindWithEvent(this,t)),s.get({"do":"getunread"})}},updateNews:function(e,t){var s=0;if("page"==e){if(e=[],$$("div.new_container_nread").each(function(e){this.push(e.get("id").split("_")[1])},e),!e.length)return}else if("read"==e){var i=$(document).getScroll().y+$("news_ordering").getPosition().y;if(e=[],$$("div.article_title.new_container_nread").each(function(e){e.getPosition().y<i&&this.push(e.get("id").split("_")[1])},e),!e.length)return}else t&&(s=$$("div[id^=new_"+e+"]")[0].hasClass("new_container_read")?1:0);this.loading(!0);var n=this.setLog(s?"Marking news as unread":"Marking news as read"),o=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});o.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,n)),o.addEvent("success",function(t,s,i){if(this.loading(!1,s),this.parseResponse(t),0===this.currentId&&0===e)$("body_container").empty(),this.pageOffset=0;else if("object"==typeof e)e.each(function(e){$$('div.article_title[id*="_'+e+'_"],div.article_title[id$="_'+e+'"]').each(function(e){e.removeClass("new_container_nread").addClass("new_container_read"),$("imgnew_"+e.get("id").split("_")[1]).addClass("hidden")})}),0!==this.currentId||$$("div.new_container_nread").length||--this.pageOffset;else if(e===this.currentId)$$("div.new_container_nread]").removeClass("new_container_nread").addClass("new_container_read"),$$("span[id^=imgnew]").setStyle("display","none"),"object"!=typeof e||0!==this.currentId&&!this.sort||--this.pageOffset;else{var n=0;0===e.toInt()?$$("div.new_container_nread").each(function(e){e.removeClass("new_container_nread").addClass("new_container_read"),++n}):i?$$("div.new_container_read").each(function(t){var s=t.get("id").split("_");(s[1]==e||s[2]==e||s[3]==e)&&(t.removeClass("new_container_read").addClass("new_container_nread"),$("imgnew_"+s[1]).setStyle("display","inline-block").removeClass("hidden"))}):$$("div.new_container_nread").each(function(t){var s=t.get("id").split("_");(s[1]==e||s[2]==e||s[3]==e)&&(t.removeClass("new_container_nread").addClass("new_container_read"),$("imgnew_"+s[1]).setStyle("display","none"),++n)}),n>0&&(0===this.currentId||this.sort)&&--this.pageOffset}}.bindWithEvent(this,[n,s])),"object"==typeof e?o.get({ids:e,"do":"upnew",currentid:this.currentId,status:s}):o.get({id:e,"do":"upnew",currentid:this.currentId,status:s})},clearLogs:function(){$("logs").empty(),this.nbLogsLine=0},showStream:function(e,t,s,i){this.ssrequest&&this.ssrequest.cancel(),this.loading(!0),e||(e=0);var n=this.setLog("Getting the news"),o=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});o.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,n)),o.addEvent("success",function(e,t,s,i,n,o){this.loading(!1,t),this.live=o,this.currentId=n,this.initCurrent(),this.parseResponse(e,null,"body_container"),this.initContents(),!this.boardTogglerStatus&&$("news_ordering")&&$("news_ordering").setStyle("top","10px");var a=new Fx.Scroll(document.body,{wheelStops:!0,offset:{x:0,y:$("contents").getPosition().y-116}});a.toTop(),this.setTS(),this.pageOffset=0,this.sort=s,this.dir=i,this.ssrequest=null}.bindWithEvent(this,[n,s,i,e,t])),o.addEvent("cancel",function(){this.loading(!1,this.ssrequest.n),this.ssrequest=null}.bindWithEvent(this)),"string"==typeof e&&-1!==e.indexOf("search_")?(e=e.split("_")[1],o.get({"do":"search",keywords:this.keywords,offset:this.pageOffset,sort:s,dir:i,id:e})):o.get({id:e,live:t,"do":"getstream",sort:s,dir:i}),this.ssrequest=o,this.ssrequest.n=n},refreshStream:function(e,t){this.loading(!0),e||(e=0),t?0!==t&&1!==t&&(t="true"===t?1:0):t=0;var s=this.setLog("Asking for refreshing of streams"),i=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});i.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,s)),i.addEvent("success",function(e,t){this.loading(!1,t),this.parseResponse(e)}.bindWithEvent(this,s)),i.get({id:e,"do":"refreshstream",currentid:this.currentId,force:t})},deleteStream:function(e){if(confirm(this.getMessage("Delete ?"))){e||(e=0),this.loading(!0);var t=this.setLog("Deleting"),s=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});s.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,t)),s.addEvent("success",function(t,s){if(this.loading(!1,s),0===e||e!=this.currentId&&0!==this.currentId?(0===e&&($("body_container").empty(),$("menu_streams").getChildren().each(function(e){"stream_0"!=e.get("id")&&e.destroy()}),$$("select[id^=move_]").each(function(e){e.getChildren("option").each(function(e){e.destroy()})})),this.parseResponse(t)):(this.parseResponse(t,null,"body_container"),this.initContents()),0!==e){$("stream_"+e)&&($("stream_"+e).destroy(),$$("select[id^=move_]").each(function(t){t.getChildren("option").each(function(t){t.get("value").toInt()===e&&t.destroy()})}));var i=$$("div[id^=new_d+]"),n=[];i.each(function(t){n=t.get("id").split("_"),(n[1]==e||n[2]==e||n[3]==e)&&(t.destroy(),$("new__"+e[1]+"_"+e[2]+"_"+e[3]).destroy())})}e==this.currentId&&(this.currentId=0)}.bindWithEvent(this,t)),s.get({"do":"delete",id:e,currentid:this.currentId})}},deleteUser:function(e){if(e&&confirm(this.getMessage("Delete ?"))){this.loading(!0);var t=this.setLog("Deleting"),s=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});s.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,t)),s.addEvent("success",function(e,t,s){this.loading(!1,t),$("user_"+s).destroy()}.bindWithEvent(this,[t,e])),s.get({"do":"delete",id:e})}},deleteNew:function(e){if(e&&confirm(this.getMessage("Delete ?"))){this.loading(!0);var t=this.setLog("Deleting"),s=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});s.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,t)),s.addEvent("success",function(e,t,s){this.loading(!1,t),$$("id^=new__?"+s).destroy()}.bindWithEvent(this,[t,e])),s.get({"do":"delete",id:e})}},moveToPage:function(e,t){if(e||(e=0),this.pageOffset!=e){t&&(ids=[],$$("div.new_container_nread").each(function(e){this.push(e.get("id").split("_")[1])},ids)),this.loading(!0),"next"===e?(e=this.pageOffset>=0?this.pageOffset+1:0,t&&(this.live||"status"==this.sort&&ids.length>0)&&e>0&&--e):"prev"===e&&(e=this.pageOffset>0?this.pageOffset-1:0,t&&(!this.live||"status"==this.sort&&ids.length>0)&&++e);var s=this.setLog(["Moving to page ",e+1]),i=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});i.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,s)),i.addEvent("success",function(t,s){this.loading(!1,s),$$("div.links[id^=moveToPage_]").destroy(),this.parseResponse(t,null,"body_container"),this.initContents(),!this.boardTogglerStatus&&$("news_ordering")&&$("news_ordering").setStyle("top","10px");var i=new Fx.Scroll(document.body,{wheelStops:!0,offset:{x:0,y:$("contents").getPosition().y-105}});i.toTop(),this.pageOffset=e}.bindWithEvent(this,s)),"string"==typeof this.currentId&&-1!==this.currentId.indexOf("search_")?i.get({"do":"search",keywords:this.keywords,offset:e,sort:this.sort,dir:this.dir,id:this.currentId.split("_")[1]}):t&&ids.length?i.get({"do":"getstream",id:this.currentId,offset:e,sort:this.sort,dir:this.dir,status:0,ids:ids,live:this.live}):i.get({"do":"getstream",id:this.currentId,offset:e,sort:this.sort,dir:this.dir,live:this.live})}},clearStream:function(e){if(confirm(this.getMessage("Delete ?"))){this.loading(!0);var t=this.setLog("Deleting news"),s=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});s.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,t)),s.addEvent("success",function(e,t){this.loading(!1,t),this.parseResponse(e,null,"body_container"),this.initContents()}.bindWithEvent(this,t)),s.get({"do":"clearstream",id:e,currentid:this.currentId})}},askMaintenance:function(){this.loading(!0);var e=this.setLog("Making the maintenance.. please wait, it may take a while"),t=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});t.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,e)),t.addEvent("success",function(e,t){this.loading(!1,t),this.parseResponse(e)}.bindWithEvent(this,e)),t.get({"do":"maintenance"})},setLog:function(e,t){if(e){var s=new Element("li"),i=new Element("span");t&&i.set("class","error");var n=new Date,o=n.getHours(),a=n.getMinutes(),r=n.getSeconds();if(i.appendText((10>o?"0"+o.toString():o)+":"+(10>a?"0"+a.toString():a)+":"+(10>r?"0"+r.toString():r)+" "),"string"!=typeof e?e.each(function(e){$defined(this.messages[e])&&(e=this.messages[e]),i.appendText(e)},this):($defined(this.messages[e])&&(e=this.messages[e]),i.appendText(e)),s.adopt(i),++this.nbLogsLine,s.set("id","logging_line_"+this.nbLogsLine),$("logs")||$("logs_container").adopt(new Element("ul",{id:"logs"})),$("logs").adopt(s),this.nbLogsLine>3){var r=new Fx.Scroll($("logs_container"),{duration:1});r.toElement(s)}return this.nbLogsLine-1}},setLang:function(e){this.loading(!0);var t=this.setLog("Setting the new interface language"),s=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});s.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,t)),s.addEvent("success",function(e,t){return this.loading(!1,t),e.errors?void this.parseResponse(e):void(window.location.href="./?token="+this.token)}.bindWithEvent(this,t)),s.post({"do":"changelang",newlang:e})},getUsersList:function(){this.loading(!0);var e=this.setLog("Getting the list of the users"),t=new Request.JSON({url:"./?token="+this.token,
	onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});t.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,e)),t.addEvent("success",function(e,t){this.loading(!1,t),this.parseResponse(e,null,"body_container"),this.currentId=0;var s=new Fx.Scroll(document.body,{wheelStops:!0,offset:{x:0,y:$("contents").getPosition().y-105}});s.toTop()}.bindWithEvent(this,e)),t.get({"do":"getusers"})},getStats:function(){this.loading(!0);var e=this.setLog("Generating some statistics"),t=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});t.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,e)),t.addEvent("success",function(e,t){this.loading(!1,t),this.parseResponse(e,null,"body_container"),this.currentId=0;var s=new Fx.Scroll(document.body,{wheelStops:!0,offset:{x:0,y:$("contents").getPosition().y-105}});s.toTop()}.bindWithEvent(this,e)),t.get({"do":"stats"})},getLastNews:function(){if(!(this.lastUpd+this.ttl>this.getTS())){this.loading(!0);var e=this.setLog("Refreshing the interface"),t=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});t.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,e)),t.addEvent("success",function(e,t){this.loading(!1,t),0===this.currentId?this.parseResponse(e):this.parseResponse(e)}.bindWithEvent(this,e)),t.get({"do":"getlastnews",currentid:this.currentId})}},confirmExit:function(){return this.isLoading&&(this.setLog("Wait wait ! A request is still running ! Please confirm you are leaving",!0),!confirm("Abort current request to the server ?"))?!1:!0},getMenuPartGroup:function(e){if(e){this.loading(!0);var t=this.setLog("Getting contents of the category"),s=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});s.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,t)),s.addEvent("success",function(t,s){this.loading(!1,s),$("groupContainer_"+e)||$("stream_"+e).adopt(new Element("ul",{id:"groupContainer_"+e,"class":"menu_groups"})),this.sortables&&this.sortables.removeLists($("groupContainer_"+e)),this.parseResponse(t,null,"groupContainer_"+e),this.initSortables(),$("gstream_toggler_"+e).setStyle("background-position","-319px 0px").status=1,$("groupContainer_"+e).setStyle("display","block").getParent().setStyle("height","auto")}.bindWithEvent(this,t)),s.get({"do":"getmenupartgroup",id:e})}},getMenuPartStream:function(e){if(e){this.loading(!0);var t=this.setLog("Getting details of the stream"),s=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});s.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,t)),s.addEvent("success",function(t,s){this.loading(!1,s),this.parseResponse(t,null,"streamContainer_"+e),$("stream_toggler_"+e).setStyle("background-position","-319px 0px").status=1,$("streamContainer_"+e).setStyle("display","block").getParents()[2].setStyle("height","auto")}.bindWithEvent(this,t)),s.get({"do":"getmenupartstream",id:e})}},getNewDetails:function(e,t){if(!e)return!1;if(t.status)$("new_details_"+e).toggle();else{this.loading(!0);var s=this.setLog("Getting details of the new"),i=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});i.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,s)),i.addEvent("success",function(e,t,s,i){this.loading(!1,t),this.parseResponse(e,null,"new_details_"+i),$("new_details_"+i).toggle(),s.status=1}.bindWithEvent(this,[s,t,e])),i.get({"do":"getnewdetails",id:e})}},getTS:function(){return Math.floor((new Date).getTime()/1e3)},setTS:function(e){e?this.TS[e]=this.getTS():this.TS[this.currentId]=this.getTS()},getCurrentTS:function(e){if(e){if($defined(this.TS[e]))return this.TS[e]}else if($defined(this.TS[this.currentId]))return this.TS[this.currentId];return this.lastUpd?this.lastUpd:$defined(this.TS[0])?this.TS[0]:0},getNew:function(e){if(e){this.loading(!0);var t=this.setLog("Getting contents of the new"),s=$(e),i=s.hasClass("new_container_nread")?1:0,n=e.split("_");idc=s.getNext();var o=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});o.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,t)),o.addEvent("success",function(e,t,s,i,n,o){this.loading(!1,t);var a=this.parseResponse(e);a&&(i.set("html",a).setStyle("visibility","visible").toggle(),o.removeClass("new_container_nread").addClass("new_container_read").addClass("opened"));var r=$("imgnew_"+s[1]);r&&r.setStyle("display","none"),0===this.currentId&&--this.pageOffset;var d=new Fx.Scroll(document.body,{wheelStops:!0,offset:{x:0,y:o.getPosition().y-105}});d.toTop()}.bindWithEvent(this,[t,n,idc,i,s])),o.get({"do":"getnewcontents",id:n[1],live:i,currentid:this.currentId,offset:this.pageOffset})}},editTags:function(e){var t=$("edit_tags_"+e);if(t)if(t.hasClass("hidden"))if(t.status)t.setStyle("display","block");else{var s=this.setLog("Getting tags"),i=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});i.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,s)),i.addEvent("success",function(e,t,s){this.loading(!1,t);var i=this.parseResponse(e);i&&s.set("value",i),s.removeClass("hidden").setStyle("display","block"),s.focus(),s.status=1}.bindWithEvent(this,[s,t])),i.get({"do":"gettags",id:e})}else"none"==t.getStyle("display")?t.setStyle("display","block"):t.setStyle("display","none")},inputEditTags:function(e,t){var s=this.setLog("Editing tags"),i=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});i.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,s)),i.addEvent("success",function(e,t,s){this.loading(!1,t);var i=this.parseResponse(e);if(i){var n=new Element("div",{html:i});$("menu_tags").adopt(n.getChildren())}this.editTags(s)}.bindWithEvent(this,[s,t])),i.post({"do":"edittagsrelations",ids:t,name:e.get("value")})},clear:function(){return this.setLog("Clearing myself, bye !"),$chk(this.period)&&$clear(this.period),delete this.period,delete this.currentId,delete this.pageOffset,delete this.menuTogglerStatus,delete this.isLoading,$chk(this.adding)&&delete this.adding,delete this.aAcc,delete this.TS,delete this.nbLogsLine,delete this.sortables,delete this.lang,delete this.adding,delete this.languages,delete this.messages,delete this.lastUpd,delete this.ttl,delete this.keywords,delete this.sort,delete this.dir,delete this.token,delete this.boardTogglerStatus,!0},getCLILogs:function(){this.loading(!0);var e=this.setLog("Asking logs"),t=new Request.JSON({url:"./?token="+this.token,onSuccess:function(e,t){e||this.parseResponse(null,t)}.bindWithEvent(this)});t.addEvent("failure",function(e,t){this.raiseXHRError(e.responseText,t)}.bindWithEvent(this,e)),t.addEvent("success",function(e,t){this.loading(!1,t),this.parseResponse(e,null,"body_container"),this.currentId=0;var s=new Fx.Scroll(document.body,{wheelStops:!0,offset:{x:0,y:$("contents").getPosition().y-105}});s.toTop()}.bindWithEvent(this,e)),t.get({"do":"getclilogs"})}};
